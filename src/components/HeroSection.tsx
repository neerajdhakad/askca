...
function HeroSection() {
  return (
    <div className="hero relative pt-24 pb-8 md:pt-0 md:py-0 px-10 md:px-20 bg-[#101010] md:bg-transparent">
      <div className="hero-content relative z-10 h-full md:h-screen w-full md:w-1/2 text-white flex flex-col items-center md:items-start justify-center">
        ...
        <h6 className="text-center font-light md:text-left text-sm md:text-xl my-5">
